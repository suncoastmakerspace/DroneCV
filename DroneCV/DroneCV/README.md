...
```bash
# Process a video file (annotated output + CSV saved automatically)
...
|---|---|
| Q / Esc | Quit |
| R | Reset counts, tracking, and heatmap |
...
| File | Contents |
|---|---|
| video_counted.mp4 | Annotated video with bounding boxes and HUD |
| video_counted.csv | Per-frame detection log (timestamp, ID, position, confidence) |
| video_counted_heatmap.png | Heatmap image showing where people appeared |
